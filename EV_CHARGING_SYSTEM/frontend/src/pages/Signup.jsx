...
import { User, Mail, Phone, Calendar, Zap, Car, Battery, Plug, CheckCircle, Loader, ArrowRight, Lock, RefreshCw } from 'lucide-react';
...
const Signup = ({ onLogin }) => {
  ...
  // Step 1: User Info - just move to next step
  ...
  // Step 2: Add Vehicle and Send OTP
  ...
  // Step 3: Verify OTP and Save to Database
            ...
            <form onSubmit={handleVehicleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-2 bg-emerald-500 hover:bg-emerald-600 disabled:bg-slate-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-2"
                >
          ...
          {step === 3 && (
            <form onSubmit={handleOTPSubmit} className="space-y-4">
              <div className="text-center mb-4">
                ...
                <p className="text-slate-400 text-xs mt-1">Check your terminal for the OTP code</p>
              </div>
